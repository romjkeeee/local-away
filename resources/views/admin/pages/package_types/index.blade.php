        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Travel purposes</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
...
@section('content')
    <div class="primary">
        <p>
            <a href="{{ route('package-types.create') }}" class="btn btn-success btn-lg">Create travel purposes</a>
        </p>
    </div>
    <?php
    $form_fields = array(
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach ($data as $user)
                            <tr>
                                ...
                                @endforeach
                                <td>
                                    <a href="{{ route('package-types.show',[$user->id]) }}">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    @role('admin')
                                    <a href="{{ route('package-types.edit',[$user->id]) }}">
