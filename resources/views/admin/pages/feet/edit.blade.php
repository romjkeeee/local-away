...
@section('content')
    ...
    <div class="card card-secondary">
        <div class="card-header">
            <h3 class="card-title">Edit Feet</h3>
        </div>
        <div class="panel panel-default">
            <div class="card-body">
                {{ Form::model($data, ['method' => 'PUT', 'enctype'=>'multipart/form-data', 'route' => ['feets.update', $data->id]]) }}
                ...
                <x-footer-button route="{{ route('feets.index') }}"></x-footer-button>
                {{ Form::close() }}
            </div>
        </div>
@stop
